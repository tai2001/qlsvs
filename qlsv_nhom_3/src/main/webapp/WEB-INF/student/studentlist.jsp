...
<header class="p-3 mb-3 border-bottom">
  ...
  <div class="container-fluid p-5 bg-primary text-white text-center">
  		...
  		<p>Quản Lý Tất Cả Sinh Viên Hiện Có!!!</p>
  </div>
  ...
  <div class="container">
  	<div class="row">
  		...
  		<a class="button" href="<%=request.getContextPath() %>/student/form">Thêm Mới</a>
  		</div>
  </div>
  <div class="row">
  	<div class="col-md-12">
  			...
  			<thead class="thead-light">
  				...
  				<c:if test="${listStudent.size() > 0 }">
  					<c:forEach var="student" items="${listStudent}">
  						<tr>
  							<td class="text-center"><c:out value="${student.id }"/></td> 
  							<td><c:out value="${student.mssv }"></c:out></td>
  							<td><c:out value="${student.hoten }"></c:out></td>
  							<td><c:out value="${student.gioitinh }"></c:out></td>
  							<td><c:out value="${student.ngaysinh }"></c:out></td>
  							<td><c:out value="${student.diachi }"></c:out></td>
  							<td><c:out value="${student.anhdaidien }"></c:out></td>
  							<td><c:out value="${student.sdt }"></c:out></td>
  							<td><c:out value="${student.email }"></c:out></td>
  							<td class="text-center">
  							<c:if test="${student.trangthai == true }">
	  								<span class="badge badge-success">Đang hoạt động</span>
  								</c:if> <c:if  test="${student.trangthai == false }">
  									<span class="badge badge-danger">Tạm khóa</span>
  								</c:if></td>
  							<td class="text-center"><a
  								href="<%=request.getContextPath() %>/student/form?id=<c:out value="${student.id }"/>">Chỉnh sửa</a> &nbsp;&nbsp;&nbsp;&nbsp; <a
  								href="<%=request.getContextPath() %>/student/delete?id=<c:out value="${student.id }"/>">Xóa</a></td>
  						</tr>
  					</c:forEach>
  				</c:if>
