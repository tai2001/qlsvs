...
<header class="p-3 mb-3 border-bottom">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="#" class="nav-link px-2 disabled px-2 link-secondary"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Quản Lý Khoa</font></font></a></li>
  ...
  <div class="container-fluid p-5 bg-primary text-white text-center">
  		<h1>QUẢN LÝ KHOA</h1>
  		<p>Quản Lý Tất Cả Khoa Hiện Có!!!</p>
  </div>
  ...
  <div class="container">
  	<div class="row">
  		...
  		<a class="button" href="<%=request.getContextPath() %>/khoa/form">Thêm Mới</a>
  		</div>
  </div>
  <div class="row">
  	<div class="col-md-12">
  		<table class="table table-bordered">
  			<thead class="thead-light">
  				...
  				<c:if test="${listKhoa.size() > 0 }">
  					<c:forEach var="khoa" items="${listKhoa}">
  						<tr>
  							<td class="text-center"><c:out value="${khoa.id }"/></td> 
  							<td><c:out value="${khoa.tenkhoa }"></c:out></td>
  							<td class="text-center">
  							<c:if test="${khoa.trangthai == true }">
	  								<span class="badge badge-success">Đang hoạt động</span>
  								</c:if> <c:if  test="${khoa.trangthai == false }">
  									<span class="badge badge-danger">Tạm khóa</span>
  								</c:if></td>
  							<td class="text-center"><a
  								href="<%=request.getContextPath() %>/khoa/form?id=<c:out value="${khoa.id }"/>">Chỉnh sửa</a> &nbsp;&nbsp;&nbsp;&nbsp; <a
  								href="<%=request.getContextPath() %>/khoa/delete?id=<c:out value="${khoa.id }"/>">Xóa</a></td>
  						</tr>
  					</c:forEach>
  				</c:if>
